    ...
    return (
        <div className='flex justify-center items-center h-[100vh]'>
            <Form onSubmit={formik.handleSubmit}>
                ...
                <Form.input_group>
                    <Link to={'/forget_password'} className='text-end text-primary m-1'>Forget password</Link>
                </Form.input_group>
                ...
                <Form.input_group>
                    <Link className='mt-[1rem]' to={'/signup'}>Create new <span className='text-primary uppercase'>account?</span></Link>
                </Form.input_group>
            </Form>
        </div>
    )
